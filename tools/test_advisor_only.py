...
async def test_vector_store_search():
    ...
    queries = ["What messenger bags do you sell?", "Do you have leather briefcases?", "I need a small bag for work"]
...
async def test_advisor():
    ...
    # Create the ClassifierOutput object with the required format
