    ...
    def test_formal_tone_adaptation(
        ...
        email_analysis = EmailAnalysis(
            ...
            tone_analysis={
                ...
                "key_phrases": ["Good day", "I am writing to inquire", "material good enough quality"]
            },
            product_references=[
                ProductReference(
...
"""
        ...
        async def verify_side_effect(response, email_body, email_subject, response_points, email_type, tone_info, llm):
            return response
    ...
    def test_casual_tone_adaptation(
        ...
        email_analysis = EmailAnalysis(
            ...
            tone_analysis={
                ...
                "key_phrases": ["Hey there", "my birthday coming up", "Anyway", "super cute"]
            },
            product_references=[
                ProductReference(
...
"""
        ...
        async def verify_side_effect_casual(response, email_body, email_subject, response_points, email_type, tone_info, llm):
            return response
    ...
    def test_out_of_stock_response(
        ...
        email_analysis = EmailAnalysis(
            ...
            product_references=[
                ProductReference(reference_text=product_data["name"], reference_type="product_name", product_id=product_data["product_id"], product_name=product_data["name"], quantity=2, confidence=0.9, excerpt="RSG8901 Retro Sunglasses")
            ],
        ...
        order_result = OrderProcessingResult(
            ...
            suggested_alternatives=[
                {"original_product_id": product_data["product_id"], "original_product_name": product_data["name"], "suggested_product_id": "ALT001", "suggested_product_name": "Alternative Sunglasses", "stock_available": 10, "price": 24.99, "reason": "Similar style"}
            ]
        )
...
The Hermes Team"""
        ...
        async def verify_side_effect_oos(response, email_body, email_subject, response_points, email_type, tone_info, llm):
            return response
    ...
    def test_promotion_inclusion(
        ...
        email_analysis = EmailAnalysis(
            classification="order_request",
            language="English",
            tone_analysis={"tone": "excited", "formality_level": 2, "key_phrases": ["summer wardrobe", "excited to try"]},
            product_references=[
                ProductReference(reference_text=product_data["name"], reference_type="product_name", product_id=product_data["product_id"], product_name=product_data["name"], quantity=1, confidence=0.9, excerpt="I want to order a Trendy T-shirt")
            ],
            customer_signals=[
                CustomerSignal(
...
The Hermes Team"""
        ...
        async def verify_side_effect_promo(response, email_body, email_subject, response_points, email_type, tone_info, llm):
            return response
    ...
    def test_natural_language_generation(
        ...
        email_analysis = EmailAnalysis(
            classification="product_inquiry",
            language="English",
            tone_analysis={"tone": "curious", "formality_level": 2, "key_phrases": ["inspired by"]},
            product_references=[
                ProductReference(reference_text=product_data["name"], reference_type="product_name", product_id=product_data["product_id"], product_name=product_data["name"], quantity=0, confidence=0.9, excerpt="Retro Sunglasses (RSG8901)")
            ],
            customer_signals=[CustomerSignal(signal_type="style_question", signal_category="Product Attribute", signal_text="What era are they inspired by?", signal_strength=0.9, excerpt="What era are they inspired by?")],
        ...
        inquiry_result = InquiryResponse(
            email_id=email_data["email_id"],
            primary_products=[
                ProductInformation(product_id=product_data["product_id"], product_name=product_data["name"], details=product_data, availability="In Stock", price=product_data.get("price"))
            ],
            answered_questions=[{"question": "What era are they inspired by?", "answer": "They are inspired by the 1960s.", "confidence": 0.9, "relevant_product_ids": [product_data["product_id"]] }],
            response_points=["Inspired by the 1960s fashion.", "Think mod style, like Twiggy.", "Perfect for a retro look."]
        )
...
The Hermes Team"""
        ...
        async def verify_side_effect_natural(response, email_body, email_subject, response_points, email_type, tone_info, llm):
            return response
        ...
        self.assertTrue(
            any(detail in response for detail in [
                "swinging London", 
                "Twiggy", 
                "statement eyewear"
            ])
...
"""
        ...
        async def verify_side_effect_spanish(response, email_body, email_subject, response_points, email_type, tone_info, llm):
            return response
        ...
        DEFAULT_GREETINGS = ["Hi", "Hello", "Thanks", "Thank you", "Best", "Sincerely", "Regards"]
