...
class TestComposer(unittest.TestCase):
    ...
    @patch("src.hermes.agents.composer.get_llm_client")
    @patch("src.hermes.agents.composer.process_customer_signals")
    @patch("src.hermes.agents.composer.generate_natural_response")
    @patch("src.hermes.agents.composer.verify_response_quality")
