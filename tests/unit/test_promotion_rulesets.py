...
import unittest
from hermes.agents.order_processor.promotion_rulesets import (
    Condition, Effect, Promo, 
    create_promotion, create_from_text, get_examples
)
...
class TestPromotionRulesets(unittest.TestCase):
    ...
    def test_buy_x_get_y_discount(self):
        ...
        promo = create_promotion(
            promotion_type="buy_x_get_y_discount",
            buy_quantity=2,
            discount_quantity=1,
    ...
    def test_free_gift(self):
        ...
        promo = create_promotion(
            ...
            gift_description="premium tote bag"
        )
    ...
    def test_custom_promotion(self):
        ...
        promo = create_promotion(
            ...
            conditions={
                Condition.MIN_QUANTITY: 2,
                Condition.APPLIES_EVERY: 2
            },
            effects={
                Effect.DISCOUNT_PERCENTAGE: 35
            }
        )
