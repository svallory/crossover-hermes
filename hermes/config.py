...
class HermesConfig(BaseModel):
    ...
    output_spreadsheet_id: str | None = Field(
        default=None, description="Google Spreadsheet ID for output results. If None, defaults to input_spreadsheet_id or a dedicated sheet name if CSV is not used."
    )
