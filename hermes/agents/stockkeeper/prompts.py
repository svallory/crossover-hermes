...
You are an AI assistant specializing in product catalog resolution. Your 
task is to determine the most likely product match based on the context provided.
...
PROMPTS[f"{Agents.STOCKKEEPER}_alternative_suggestion"] = PromptTemplate.from_template(ALTERNATIVE_SUGGESTION_PROMPT_STR)
