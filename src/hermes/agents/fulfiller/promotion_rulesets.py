...
EXAMPLE_PROMOTIONS: Dict[str, PromotionSpec] = {
    ...
    "percentage_discount": {
        ...
        "effects": {"apply_discount": {"type": "percentage", "amount": 25}},
    },
    # Fixed amount discount (e.g. "$25 off your order")
    "fixed_amount_discount": {
        "conditions": {"min_quantity": 1},
        "effects": {"apply_discount": {"type": "fixed", "amount": 25.0}},
    },
    # 10% discount when buying 3 or more items
    "bulk_discount": {
        "conditions": {"min_quantity": 3, "applies_every": 1},
        "effects": {"apply_discount": {"type": "percentage", "amount": 10}},
    },
    ...
    "buy_x_get_y_discount": {
        ...
        "effects": {"apply_discount": {"type": "percentage", "amount": 50}},
    },
    # Free gift (e.g. "Buy now and get a free matching beanie!")
    "free_gift": {"conditions": {"min_quantity": 1}, "effects": {"free_gift": "matching beanie"}},
    ...
    "combo_deal": {
        "conditions": {
            ...
            "product_combination": [
                "JKT5432",
                "SWT7651",
            ],  # All of these products must be present to trigger the promotion
        },
        "effects": {
            "apply_discount": {
